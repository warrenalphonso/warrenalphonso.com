...
const Clusters = (): JSX.Element => {
  return (
    <>
      <Head>
        <title>Clusters | Warren Alphonso</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div>
        <h1>Clusters</h1>

        <p>Reading and writing organized by theme.</p>

        <div className="cluster">
          <p className="cluster-text">Seeing Life Through Death</p>
        </div>
        <ReadingList>
          <ReadingItem>
        ...
        <div className="cluster">
          <p className="cluster-text">Loving Other People</p>
        </div>
        <ReadingList>
          <ReadingItem>
        ...
        <div className="cluster">
          <p className="cluster-text">Optimistic Fiction</p>
        </div>
        <ReadingList>
          <ReadingItem>
